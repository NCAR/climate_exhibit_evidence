...
controller('modelItCtrl', function ($rootScope, $scope, ContentData) {
...
var dataTableUsual = [
    ...
    function init() {
      if (!$rootScope.modelChartHasInitialized)
      {
        ...
        google.charts.setOnLoadCallback(function(){ drawChart(); drawHistoricalChart()});
      }
      else
      {
        drawChart();
      ...
      for(var x=0;x<11;x++)
      {
        ...
        var options_stacked = {
          /*animation : 
            ...
            titlePosition: 'none',
            titleTextStyle: {color:'#0c1c48', fontSize:'28', fontName: 'Roboto Slab', left:'200'},
            isStacked: 'absolute',
            height: 690,
            areaOpacity: 0.5,
            legend: {position: 'none'},
            series: {
              11: {type:'line', color: '#f23573', lineDashStyle:[2,2]}
            },
            ...
            vAxis: {minValue: 56.3, ticks: [57,58,59,60,61,62,63,64], title:"Average global temperature (degrees F)", 
                  titleTextStyle: {italic:false, bold:true, fontSize:18},
                  format: '##.#',
            ...
            hAxis: {minValue:1900, ticks: [1900, 2010,2020, 2030, 2040, 2050, 2060, 2070, 2080, 2090], title:"",
                    titleTextStyle: {italic:false, bold:true, left:10}
                  },
            backgroundColor: '#dcf8fa',
            chartArea:{left:80,top:30,width:"90%",height:"88%"},
    ...
    function drawHistoricalChart() {
      //HISTORICAL DATA -- SECOND CHART
        ...
        var hoptions = {
          ...
          hAxis:{format:'none', textPosition:'none', gridlines: {color: 'transparent'}},
